/*
 * Pantalla Registro de nuevos usuarios
 *  
 * Autores:
    ...
    const handleOnSubmit = async (event) => {
        ...
        try{
            if(state.usuario.trim() !== ''){
                ...
                const logData = {usuario:session.nombre, fecha: new Date().toLocaleString(), accion: "Creó un usuario", folio: state.usuario, area: "Gestión de usuarios"}
