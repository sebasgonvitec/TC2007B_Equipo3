...
var BooleanFilter = /** @class */ (function (_super) {
    ...
    BooleanFilter.prototype.render = function () {
        return (React.createElement(EnumFilter_1.EnumFilter, { filter: this.props.filter, onFilterChange: this.props.onFilterChange, data: this.props.data || this.data, defaultItem: this.props.defaultItem, ariaLabel: this.props.ariaLabel }));
    };
    /**
     * @hidden
     */
